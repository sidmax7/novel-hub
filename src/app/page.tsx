...
import { Search, Menu, BookOpen, Star, Moon, Sun } from "lucide-react"
            ...
            >
              <motion.div className="space-y-6" variants={fadeIn}>
                ...
                <p className="text-gray-100 md:text-lg">
                  Dive into a world of magic and adventure with our bestselling light novel series.
                </p>
            ...
            >
              {[1, 2, 3, 4, 5, 6, 7, 8].map((novel) => (
                ...
                >
                  ...
                  >
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Light Novel Title {novel}</h3>
